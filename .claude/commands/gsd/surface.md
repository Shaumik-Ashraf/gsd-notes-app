...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/commands/gsd
AGENTS_DIR=/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents
```
...
<execution_context>
Surface state file: `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/skills/.gsd-profile`
Engine module: `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
