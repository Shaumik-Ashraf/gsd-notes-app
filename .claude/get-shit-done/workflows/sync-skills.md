...
INSTALL_JS_GLOBAL="/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
