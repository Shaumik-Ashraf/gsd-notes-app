...
- **Global scope**: `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/notes/`)
...
2. Glob `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/notes/` — works in any directory
