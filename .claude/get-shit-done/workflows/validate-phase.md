...
```
Agent(
  prompt="Read /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/VALIDATION.md`
