...
```markdown
Read /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-ui-checker.md for instructions.
