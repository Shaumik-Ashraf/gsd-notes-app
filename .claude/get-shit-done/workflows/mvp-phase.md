...
<required_reading>
@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/user-story-template.md
@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/spidr-splitting.md
@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
