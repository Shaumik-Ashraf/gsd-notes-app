...
```bash
INIT=$(node "/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
