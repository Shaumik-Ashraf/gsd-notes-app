...
```bash
INIT=$(node "/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/spec.md.
