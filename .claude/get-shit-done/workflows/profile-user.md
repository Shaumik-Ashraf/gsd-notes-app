...
Key references:
- @/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/USER-PROFILE.md" "/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/CLAUDE.md
```
