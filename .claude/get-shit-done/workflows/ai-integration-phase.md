...
<required_reading>
@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/ai-frameworks.md
@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/agents/gsd-eval-planner.md for instructions.
