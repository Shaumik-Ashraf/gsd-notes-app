...
- Usage: Reference from command with `@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/cydra/tmp/try-gsd/gsd-notes-app/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
