...
<reference>
@/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/references/user-profiling.md` to load:
