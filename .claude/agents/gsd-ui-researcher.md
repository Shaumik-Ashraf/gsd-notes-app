...
Use template from `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/UI-SPEC.md`
