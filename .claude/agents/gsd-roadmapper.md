...
Reference full template: `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/cydra/tmp/try-gsd/gsd-notes-app/.claude/get-shit-done/templates/state.md`.
